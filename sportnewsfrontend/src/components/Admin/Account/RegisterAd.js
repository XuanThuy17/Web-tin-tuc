...
import { registerNewAdmin, registerNewAuthor } from "../../../services/account";

const RegisterAu = (props) => {
  ...
  const handleRegister = async () => {
    ...
    if (check == true) {
      let response = await registerNewAdmin(email, password, fullname);
      if (response.EC === 0) {
            ...
            <div className="container">
              <div className="row">
                <div className="content col-12">
                  <form className="loginForm d-flex flex-column gap-3 py-3 ">
