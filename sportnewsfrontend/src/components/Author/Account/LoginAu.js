...
import '../Account/LoginAu.scss'
import RegisterAu from './RegisterAu';
import { NavLink } from 'react-bootstrap';
import { toast } from 'react-toastify';
import {loginAuthor} from '../../../services/account'
...
const LoginAu = (props) => {
    ...
    const handleLogin = async (e) => {
        ...
        let response = await loginAuthor(email, password);
            ...
            <div className='container'>
                <div className='row px-5 px-sm-0'>
                    <div className='content-left col-sm-7 d-none d-sm-block'>
                        <div className='loginTitle'>Author News</div>
